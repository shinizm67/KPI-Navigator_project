...
更新日: 2026-06-17  
ステータス: **実装中** — P0 / 1 / 3 / 4 / 5 / 5b / 5c / 6 / 6b / **8** 完了。**Phase 2 / 10 / 9 / 11** 残。
...
| **10** | **Daily Floating Window KPI 配線** — `#daily-overlay` を Store / TW 算出と同期（詳細 `docs/daily-page-graph.md`） | 8 | 🟡 |
| **9** | **Focus Bar Graph ポップオーバー** — フォーカス日の Daily / Monthly / Annual KPI + 達成率バー（Annual / Monthly 共通・詳細 §15.5） | 8 | ⬜ |
