 ...
 * ブランド表示名は KPI Pilot（docs/brand-kpi-pilot-rename-memo.md）。URL パスは当面 kpi-navigator。
 */
(function () {
  'use strict';
