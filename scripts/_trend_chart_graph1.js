      ...
      function initGraphMonthlyCumulativeTrendGraph1() {
        var root = document.getElementById('insight-graph-monthly-graph1');
        var frame = root && root.querySelector('.insight-graph-monthly-trend__frame');
        var svg = document.getElementById('insight-graph-monthly-graph1-chart');
        if (!frame || !svg) return;
        ...
        var hoverRect = document.getElementById('insight-graph-monthly-graph1-hover');
        var periodEl = document.getElementById('insight-graph-monthly-graph1-period');
        var achievementEl = document.getElementById('insight-graph-monthly-graph1-achievement');
        var tooltipEl = document.getElementById('insight-graph-monthly-graph1-tooltip');
        var endKgiEl = document.getElementById('insight-graph-monthly-graph1-end-kgi');
        var endKpiEl = document.getElementById('insight-graph-monthly-graph1-end-kpi');
        ...
        function hideHoverUi() {
          if (frame.__trendHoverEls) {
            ...
            frame.__trendHoverEls.hitDot.classList.remove(
              'is-visible',
              'insight-graph-monthly-trend__hit-dot--kgi',
              'insight-graph-monthly-trend__hit-dot--kpi'
            );
          }
          if (tooltipEl) {
        ...
        function showHoverUi(hit, state) {
          ...
          els.hitDot.classList.remove('insight-graph-monthly-trend__hit-dot--kgi', 'insight-graph-monthly-trend__hit-dot--kpi');
