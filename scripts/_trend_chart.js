      ...
      function initGraphMonthlyCumulativeTrend() {
        ...
        var endCurrentEl = document.getElementById('insight-graph-monthly-trend-end-current');
        var endLastYearEl = document.getElementById('insight-graph-monthly-trend-end-last-year');
        var endBestEl = document.getElementById('insight-graph-monthly-trend-end-best');
        ...
        function render() {
          ...
          var lyAtToday = payload.lastYear[payload.todayDay - 1];
          var curAtToday = payload.current[payload.todayDay - 1];
          if (achievementEl) {
            var ach = lyAtToday > 0 ? (curAtToday / lyAtToday) * 100 : 0;
            achievementEl.textContent = ach.toFixed(1) + '%';
          }
