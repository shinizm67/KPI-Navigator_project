...
PROFILE_REPLACEMENTS = [
    ...
    ("Company Name :", "公司名稱 :"),
    ("Industry :", "產業 :"),
    ("Cuisine / Genre (Optional)", "料理類型（選填）"),
    ("Retail Genre (Optional)", "零售類型（選填）"),
    ("Salon Type (Optional)", "沙龍類型（選填）"),
    ("Fitness Type (Optional)", "健身類型（選填）"),
    ("Lodging Type (Optional)", "住宿類型（選填）"),
    ("Business details (Optional)", "業種詳情（選填）"),
    ("Choose a suggestion, or type your own category / genre.", "可從候選項目選擇，或自行輸入您的業態／類型。"),
    ("Choose a country or enter your own", "請選擇國家，或自行輸入"),
    ("Choose a state / prefecture or enter your own", "請選擇縣市／州，或自行輸入"),
    ("Choose a city / town or enter your own", "請選擇城市／地區，或自行輸入"),
    ("Saved state and city values are kept if you change country.", "變更國家時，已儲存的縣市／城市不會自動刪除。"),
    ("City / Town :", "城市 :"),
    ("Genre :", "類型 :"),
    ("Country :", "國家 :"),
    ...
    ('aria-label="Cuisine / Genre (Optional)"', 'aria-label="料理類型（選填）"'),
    ('aria-label="Input hint"', 'aria-label="輸入提示"'),
